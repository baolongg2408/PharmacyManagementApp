...
const LoginScreen = ({ onLogin }) => {
  ...
  const handleLogin = async () => {
    try {
      ...
      // kiểm tra nếu là kh
      const customerResponse = await fetch('http://192.168.229.40:5000/pharmacy/khachHang');
      ...
      // iểm tra nếu là nv
      const employeeResponse = await fetch('http://192.168.229.40:5000/pharmacy/nhanVien');
